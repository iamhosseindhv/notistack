...
class SnackbarProvider extends Component {
    ...
    handlePresentSnackbar = (variant, message) => {
        if (process.env.NODE_ENV !== 'production') {
            console.warn('DEPRECATED: method \'onPresentSnackbar\' has  been  deprecated and will be removed in future versions of notistack. Please use \'enqueueSnackbar\' method instead. see LINK TO DOC for more info.');
        }
        this.queue.push({
            message,
            variant,
